...
public:
 ...
 while (true) {
    ...
    if (cin.fail()) {
        try {
            throw "Invalid age entered! Please enter a numeric value.";
    ...
    vector<string> validBG = {"O+", "O-", "A+", "A-", "B+", "B-", "AB+", "AB-"};
    while (true) {
        ...
        if (find(validBG.begin(), validBG.end(), bloodgp) != validBG.end()) {
            break;
        } else {
    ...
    while (true)
    {
        ...
        case 3:
            while(1){
                ...
                cin.ignore(numeric_limits<streamsize>::max(), '\n');
                try{
                    if(tempChar != 'M' && tempChar != 'F' && tempChar != 'm' && tempChar != 'f'){
        ...
        case 4:
            while(1){
                ...
                cin >> tempStr;
                try{
                    if(tempStr =="O+" || tempStr=="O-" || tempStr=="A+" || tempStr=="A-" || tempStr=="B+" || tempStr=="B-" || tempStr=="AB+" || tempStr=="AB-" || tempStr =="o+" || tempStr=="o-" || tempStr=="a+" || tempStr=="a-" || tempStr=="b+" || tempStr=="b-" || tempStr=="ab+" || tempStr=="ab-"){
                        bloodgp = tempStr;
                        break;
                    }
                    else {
